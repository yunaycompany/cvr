...
const mainNetRSKURLProvider = process.env.MAINNET_URL_PROVIDER
...
module.exports = {
  ...
  networks: {
    ...
    testnetbsc: {
      provider: () => new HDWalletProvider(mnemonicTestnetBSC, `https://data-seed-prebsc-1-s1.binance.org:8545`),
      network_id: 97,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    bsc: {
      provider: () => new HDWalletProvider(mnemonicMainNetBSC, `https://bsc-dataseed1.binance.org`),
      network_id: 56,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    mainnetrsk: {
      provider: () => new HDWalletProvider(mnemonicMainNetRSK, mainNetRSKURLProvider),
      network_id: '30',
      // gasPrice: 0x4C85D80,
      //skipDryRun: true
    },
